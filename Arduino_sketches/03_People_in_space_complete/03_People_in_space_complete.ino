...
int positions[6] = {160,125,85,60,30,0};
   ...
   if(WiFi.status()== WL_CONNECTED){
      ...
      if(httpResponseCode<=0){
         ...
         if (JSON.typeof(space_data) == "undefined") {
            ...
            // Constrain keeps the number between 0 and 5 (that was all my scale had)
            motor1.write(positions[constrain(num_in_space,0,5)]);
         }
      }
